...
exponent = [1.5, 1.5]
if Use_HDR:
    HDR_extra_shoulder_power = numpy.power(HDR_SDR_ratio, numpy.log10(HDR_extra_shoulder_power_factor))
...
def AgX_Rec2100(col, mix_percent):
    ...
    for i in range(x):
        for j in range(y):
            for k in range(z):
                ...
                col = AgX_Rec2100(col, mix_percent)
